...
def build_schedule_view(schedule_text: str,
    ...
    for g in games:
        ...
        block = format_matchup_block(g, stats_a, stats_b, width_team, width_recseq, pitcher_map, batter_map)                block = format_matchup_block(g, stats_a, stats_b, width_team, width_recseq, pitcher_map, batter_map)
        blocks.append(block)
    return "\n".join(blocks)
